...
Das colunas acima, iremos utilizar "Age", "Primary Streaming Service" e "Music effects", aplicando filtros para desconsiderar linhas com dados NA em cada ocasião. Já BPM (batimentos por minuto) possui um número significativo de NA então não será levada em consideração.
